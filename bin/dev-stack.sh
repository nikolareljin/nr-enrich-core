...
load_env_file() {
    ...
    export PIMCORE_SKELETON_VERSION="${PIMCORE_SKELETON_VERSION:-2025.4.2}"
    export PIMCORE_PACKAGE_VERSION="${PIMCORE_PACKAGE_VERSION:-^12.3.10}"
    export PIMCORE_ADMIN_UI_CLASSIC_BUNDLE_VERSION="${PIMCORE_ADMIN_UI_CLASSIC_BUNDLE_VERSION:-^2.3}"
}
