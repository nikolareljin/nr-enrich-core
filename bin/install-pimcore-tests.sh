...
# No 'composer config audit.block-insecure false' here. It wrote into the
# tracked composer.json and disabled the advisory check for everyone who ran
# this script. It existed because Pimcore 11 carried unpatched advisories;
# on Pimcore 12.3.10+ the install resolves without it. If it ever fails on an
# advisory again, that is a signal to read, not a flag to restore.
