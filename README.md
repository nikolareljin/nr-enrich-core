...
The default bootstrap is pinned to a Pimcore 12 compatible skeleton (`2025.4.2`) and package version (`^12.3.10`) so `./start` stays reproducible when newer Pimcore releases move on.
